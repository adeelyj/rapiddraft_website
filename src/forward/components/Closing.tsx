// Forward × RapidDraft — questions for the meeting, drawn from our own deep
...
const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    subtitle:
      'Separates real DfS engineering from CSR theater — indicates whether sustainability data is a live design input the CO₂ agent should surface at concept stage.',
